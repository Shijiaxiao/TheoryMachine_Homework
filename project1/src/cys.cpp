...
void drawPoint(serial alpha) {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/Image_position_F.tiff", image_position);
    cv::imwrite("../images_cys/JPEG/Image_position_F.jpeg", image_position);
...
void drawVLine(serial alpha) {
    ...
    // Save images:
    cv::imwrite("../images_cys/TIFF/Image_Fvx_angle.tiff", image_vx_angle);
    cv::imwrite("../images_cys/TIFF/Image_Fvy_angle.tiff", image_vy_angle);
    cv::imwrite("../images_cys/JPEG/Image_Fvx_angle.jpeg", image_vx_angle);
    cv::imwrite("../images_cys/JPEG/Image_Fvy_angle.jpeg", image_vy_angle);
...
void drawALine(serial alpha) {
    ...
    // Save images:
    cv::imwrite("../images_cys/TIFF/Image_Fax_angle.tiff", image_ax_angle);
    cv::imwrite("../images_cys/TIFF/Image_Fay_angle.tiff", image_ay_angle);
    cv::imwrite("../images_cys/JPEG/Image_Fax_angle.jpeg", image_ax_angle);
    cv::imwrite("../images_cys/JPEG/Image_Fay_angle.jpeg", image_ay_angle);
...
void drawMovements(serial alpha) {
    ...
    cv::VideoWriter video("../images_cys/VIDEO/Movement.mp4", fourcc, fps, image_temp.size());
    ...
    for (int i = 0; i < pos[alpha].size(); i++) {
        ...
        cv::putText(image, "Author: ChengYusi", cv::Point(image.cols-2*x_add-320, y_add+100), cv::FONT_HERSHEY_SIMPLEX, 2.2, cv::Scalar(230,216,173), 3, 6);
