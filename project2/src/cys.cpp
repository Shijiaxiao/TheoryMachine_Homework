...
const double stroke = 30.0;              // Stroke
const double cam_angle1 = 140.0;         // Push up
const double cam_angle2 = 140.0;         // Push down
const double pressure_angle1 = 30.0;     // Pressure1
const double pressure_angle2 = 70.0;     // Pressure2
const double stop_angle_far = 50.0;      // Stop far
const double stop_angle_near = 30.0;     // Stop near
const double w = 2 * PI;                 // omega

// Outline parameters:
const double r_roller = 10.0;                          // Roller radius
const double r_base = 43.0;                            // Base radius
const double s0 = 40.0;                                // Base displacement
...
void drawSTheta() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_s_theta.tiff", image_s_theta);
    cv::imwrite("../images_cys/JPEG/image_s_theta.jpeg", image_s_theta);
...
void drawVTheta() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_v_theta.tiff", image_v_theta);
    cv::imwrite("../images_cys/JPEG/image_v_theta.jpeg", image_v_theta);
...
void drawATheta() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_a_theta.tiff", image_a_theta);
    cv::imwrite("../images_cys/JPEG/image_a_theta.jpeg", image_a_theta);
...
void drawDsDthetaS() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_ds_dtheta_s.tiff", image_ds_dtheta_s);
    cv::imwrite("../images_cys/JPEG/image_ds_dtheta_s.jpeg", image_ds_dtheta_s);
...
void drawAlphaTheta() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_alpha_theta.tiff", image_alpha_theta);
    cv::imwrite("../images_cys/JPEG/image_alpha_theta.jpeg", image_alpha_theta);
...
void drawRadiusTheta() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_radius_theta.tiff", image_radius_theta);
    cv::imwrite("../images_cys/JPEG/image_radius_theta.jpeg", image_radius_theta);
...
void drawTheoryActual() {
    ...
    // Save image:
    cv::imwrite("../images_cys/TIFF/image_theory_actual.tiff", image_theory_actual);
    cv::imwrite("../images_cys/JPEG/image_theory_actual.jpeg", image_theory_actual);
...
void generateMovement() {
    ...
    cv::VideoWriter video("../images_cys/VIDEO/Movements.mp4", fourcc, fps, image_temp.size());
    ...
    for (int i = 0; i < N; i++) {
        ...
        cv::putText(image, "Author: ChengYusi", cv::Point(image.cols-2*x_add-120, y_add+120), cv::FONT_HERSHEY_SIMPLEX, 2.2, cv::Scalar(230,216,173), 3, 6);
...
void generateMovementS() {
    ...
    cv::VideoWriter video("../images_cys/VIDEO/Movements_S.mp4", fourcc, fps, image_temp.size());
    ...
    for (int i = 0; i < N; i++) {
        ...
        cv::putText(image, "Author: ChengYusi", cv::Point(x_max - x_min + 5 * x_add + 400, y_max + 2 * y_add + 500), cv::FONT_HERSHEY_SIMPLEX, 3, cv::Scalar(230,216,173), 3, 6);
